...
public:
	...
	Color checkColorValue(T colorValue) {
		...
		if (colorValue == 0) {
			return Color{ 255, 0, 13, opacity}; //red
		}
		else if (colorValue == 1) {
			return Color{ 0, 0, 200, opacity }; //blue
		}
		else if (colorValue == 2) {
			return Color{ 255, 255, 255, opacity }; //white
		}
		else if (colorValue == 3) {
			return Color{ 128, 0, 128, opacity}; //purple
		}
		else if (colorValue == 4) {
			return Color{ 128, 128, 128, opacity };	//gray
		}
		else if (colorValue == 5) {
			return Color{ 255, 255, 255, opacity };	//white
		}
		else {
			return Color{ 255, 165, 0, opacity }; //orange
		}
	}
